    ...
    <div className="flex flex-col gap-4 rounded-lg">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          >
            <Select.Trigger className="h-10 flex items-center justify-between px-3 py-2 border border-gray-600 rounded-md bg-zinc-800 text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-zinc-700 transition-colors">
              <Select.Value />
              <Select.Icon>
